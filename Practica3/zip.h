...
//void process_zip_entries(const std::string& path, zip_t* zip);
void read_zip_entry(zip_t* zip, const std::string& entryName, const std::string& parentPath);
ssize_t zip_entry_read(zip_t* zip, void** buf, size_t* bufsize);
int zip_entry_next(zip_t* zip);
#ifdef __cplusplus
}
#endif
